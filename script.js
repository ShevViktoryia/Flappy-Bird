...
const final_table = document.querySelector(".final-table");
...
function addScoreResult(score) {
  const results = JSON.parse(localStorage.getItem("scoreResults")) || [];
  ...
  localStorage.setItem("scoreResults", JSON.stringify(results));
  gameResult = JSON.parse(localStorage.getItem("scoreResults"));
}
